...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_7__["default"])(modalState, '#size', '#material', '#options', '.promocode', '.calc-price');
...
var accordion = function accordion(heading) {
  var accordionHead = document.querySelectorAll(heading);
  var btnNumber; // переменная не позволяет функции сработать, когда открыт таб, а пользователь кликает на него для закрытия.

  accordionHead.forEach(function (btn, i) {
  ...
  function hide() {
    accordionHead.forEach(function (activeBtn, i) {
...
/* harmony default export */ __webpack_exports__["default"] = (accordion); // function hideBlocks() {
//     accordionBlocks.forEach(block => {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function getData(selector) {
    Object(_services_request__WEBPACK_IMPORTED_MODULE_6__["getResource"])('assets/calcPrise.json').then(function (res) {
      var selectOptions = document.querySelectorAll("".concat(selector, " option"));
      res.values.forEach(function (element) {
        selectOptions.forEach(function (item, i) {
          switch (selector) {
            case size:
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var changeModalState = function changeModalState(state, size, material, options, promocode, result) {
  var sizeBlock = document.querySelector(size),
      materialBlock = document.querySelector(material),
      optionsBlock = document.querySelector(options),
      promocodeBlock = document.querySelector(promocode),
  ...
  var bindValues = function bindValues(event, elem, prop) {
...
var drop = function drop() {
  ...
  //dragexit *
  //dragleave - объект за приделами dropArea
  //dragover - объект зависает над dropArea
  //dragstart *
  //drop - объект отправлен в dropArea
  //* - события, которые срабатывают на перетаскивемом объекте.
...
var filter = function filter() {
  ...
  function showActiveWorks() {
    btns.forEach(function (item) {
      ...
      var btn = menu.querySelector(".".concat(itemClass));
      var itemMark = wrapper.querySelectorAll(".".concat(itemClass));
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // checkNum('input[name="user_phone"]');
...
var scrolling = function scrolling(upSelector) {
  ...
  //             smooveScroll(scrollTop, hashElementTop, this.hash);
  //         }
  //     });
  // };
  // const smooveScroll = (from, to, hash) => {
  //     let timeintrval = 1,
  //         prevScrollTop,
  //         speed;
  //     if (to > from) {
...
/* harmony import */ var _services_request__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/request */ "./src/js/services/request.js");
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    ...
    Object(_services_request__WEBPACK_IMPORTED_MODULE_4__["getResource"])('assets/db.json').then(function (res) {
...
var sliders = function sliders(slides, direct, prev, next) {
  var slideIndex = 1;
  var paused = false;
